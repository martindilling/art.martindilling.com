...
<div id="app" class="flex-1 block md:flex flex-col border-t-4 border-indigo-lighter">
    <nav class="flex items-center justify-between flex-wrap shadow-md bg-teal px-2 py-4">
        <a href="{{ route('home') }}" class="flex items-center flex-no-shrink text-white no-underline mr-4 px-2 rounded focus:outline-none focus:shadow-outline">
        ...
        <div class="block md:hidden">
            <button
                onclick="document.querySelector('[data-navbar-content]').classList.toggle('hidden')"
                class="flex items-center px-3 py-2 border rounded text-teal-lighter border-teal-light hover:text-white hover:border-white rounded focus:outline-none focus:shadow-outline"
            >
        ...
        <div data-navbar-content class="w-full block flex-grow md:flex md:items-center md:w-auto hidden md:block">
            <div class="text-sm md:flex-grow">
                <a href="{{ route('home') }}" class="block px-1 py-2 mt-2 md:inline-block md:mt-0 text-teal-lighter hover:text-white no-underline mr-4 rounded focus:outline-none focus:shadow-outline">
                    {{ __('Dashboard') }}
                </a>
                <a href="{{ route('admin.products.create') }}" class="block px-1 py-2 mt-2 md:inline-block md:mt-0 text-teal-lighter hover:text-white no-underline mr-4 rounded focus:outline-none focus:shadow-outline">
                    {{ __('New product') }}
                </a>
                <a href="{{ route('admin.products.index') }}" class="block px-1 py-2 mt-2 md:inline-block md:mt-0 text-teal-lighter hover:text-white no-underline mr-4 rounded focus:outline-none focus:shadow-outline">
                    {{ __('Products') }}
                </a>
                <a href="{{ route('admin.orders.index') }}" class="block px-1 py-2 mt-2 md:inline-block md:mt-0 text-teal-lighter hover:text-white no-underline mr-4 rounded focus:outline-none focus:shadow-outline">
                    {{ __('Orders') }}
                </a>
            </div>
            <div class="text-sm">
